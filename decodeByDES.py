"""
# filename:decodeByDES.py
# author:heizhou
# No.:150420226
# date:17/9/27
# purpose:This file is to decode by DES algorithm
"""
...
class DESDecode():
    ...
    def decode(self, from_code, key, code_len):
        output = ""
        trun_len = 0
...
def entry(from_code, key):
    """the entry for des decode function"""
    de = DESDecode()
    ...
    key_code = de.decode(from_code, key, string_len)
    return DC.hexToUni(key_code)
